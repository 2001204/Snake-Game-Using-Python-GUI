...
Button(text="Player1= X, Player2= O", font=('MS Serif', 14,'bold'), bg='coral1', fg='white',
            border=5, width=4,).grid(row=0, column=0, sticky="we")
Button(text="Tic-Tac-Toe", font=('Times new roman', 22, 'bold'), bg='magenta', fg='white',
            border=10, width=5,).grid(row=0, column=1, sticky="we")
Button(text="New Game..", font=('Verdana', 14,'bold'), bg='SteelBlue1', fg='white',
            border=5, width=4,command = lambda :Restart()).grid(row=0, column=2, sticky="we")
Button(text="EXIT", font=('Verdana', 14,'bold'), bg='red', fg='white',
            border=5, width=4,command = lambda :quit()).grid(row=4, column=1, sticky="we")
root.resizable(0,0)
root.mainloop()
#End of the code
